...
# fc_sigmoid，conv_layer，max_pooling，global_average_pooling，bn_layer
...
class resnet18:
    ...
    def __init__(self, num_classes):
        self.pre = [
            conv_layer(3, 64, 3, 3, stride=1, shift=False), # 7,7,2
            bn_layer(64),
            relu(),
            # max_pooling(3,3,2,same=True)
        ]
        self.layer1 = self.stack_ResBlock(64, 64, 2, 1) # in_channels, out_channels, block_num, stride，3,4,6,3
        ...
        self.fc = fc_sigmoid(512, num_classes) # in_channels, out_channels
